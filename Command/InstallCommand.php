...
class InstallCommand extends ContainerAwareCommand
{
    ...
    {
        $queries = [
            'CREATE TABLE webburza_sylius_article (id INT AUTO_INCREMENT NOT NULL, published TINYINT(1) NOT NULL, featured TINYINT(1) NOT NULL, published_at DATETIME DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB',
    ...
    private function createPermissions($manager)
    {
        ...
        $managePermission->setParent($contentPermission);
        ...
        // Persist the manage (parent) permission
        $manager->persist($managePermission);
        $manager->flush();
    }
}
